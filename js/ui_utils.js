/**
 * UI Utilities & Presentation Helpers
 * UI Layer: Screen Switching, Announcements, Dialogs, Toasts, Avatars
 */
...
(function(window) {
    ...
    function switchScreen(id) {
        if (id !== 'screen-splash' && typeof window.LicenseManager !== 'undefined' && !window.LicenseManager.isActivated()) {
            window.LicenseManager.showModal(() => {
                switchScreen(id);
            });
            return;
        }
    ...
    function showLogoPopup(qCount) {
        ...
        if (overlay) {
            const txt = document.getElementById('logo-popup-text');
            if (txt) txt.textContent = "Mashallah! " + qCount + " Questions!";
            if (window.SFX && window.SFX.applause) window.SFX.applause();
            ...
            input.addEventListener('change', function(e) {
                ...
                reader.onload = function(evt) {
                    ...
                    img.onload = function() {
                        ...
                        window.currentStudentAvatar = currentStudentAvatar;
    ...
    function renderSetupUI() {
        ...
        if (typeof window.RuleSelectorEngine !== 'undefined') {
            window.activeRseInstance = window.RuleSelectorEngine.render(container, {
                initialSelection: {},
    ...
    window.showLogoPopup = showLogoPopup;
    window.bindAvatarUploads = bindAvatarUploads;
    window.renderSetupUI = renderSetupUI;
